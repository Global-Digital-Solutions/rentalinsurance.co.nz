            ...
            <div className="bg-emerald-600 text-white rounded-lg p-8">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <span className="text-lg"><strong>Licensed Providers:</strong> We work exclusively with Financial Markets Authority registered providers to ensure you're protected by industry standards</span>
                </li>
                <li className="flex gap-3">
                  <span className="font-bold text-emerald-200 text-xl">✓</span>
