          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl p-6 border border-slate-200">
              ...
              <p className="text-slate-600 text-sm leading-relaxed mb-4">
                Contact your insurer directly in the first instance. Most NZ insurers are members of the <a href="https://www.icnz.org.nz" target="_blank" rel="noopener noreferrer" className="text-sky-600 hover:underline font-medium">Insurance Council of NZ (ICNZ)</a> and are bound by the Fair Insurance Code.
              </p>
